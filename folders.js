 /**
         * Encapsulates the drag logic for a single folder instance.
         * By defining the state (isDragging, offset) inside this function, 
         * we ensure it's unique to the specific folder/header pair via closure.
         */
